...
| **2** | **Văn Nguyễn Thành Đạt** | **3124411067** | **CHƯƠNG 2: Data Understanding**<br>**CHƯƠNG 3: Data Preparation** | - Thực hiện EDA, vẽ Heatmap Missing Values<br>- Phân tích phân phối giá SalePrice (Skewness)<br>- Lọc Outliers > 4000 sq ft theo Paper De Cock<br>- Xử lý Missing Value (Mean/Mode) & OHE |
| **3** | **Lê Văn Hiếu** | **3124411091** | **CHƯƠNG 4: Modeling** | - Xây dựng Baseline Decision Tree<br>- Cài đặt mô hình XGBoost Regressor & RandomizedSearchCV<br>- Tuning siêu tham số tối ưu & xuất file nộp Kaggle<br>- Thiết kế & huấn luyện mạng Deep Learning ANN (Keras) |
| **4** | **Cái Trần Minh Tiến** | **3124411309** | **CHƯƠNG 5: Evaluation & Error Analysis** | - Tính toán các thang đo RMSLE, MAE, RMSE, R²<br>- Lập bảng tổng hợp so sánh định lượng các mô hình<br>- Trực quan hóa Predicted vs Actual & Residual Plot<br>- Đánh giá Feature Importance & Phân tích sai số thực tế |
